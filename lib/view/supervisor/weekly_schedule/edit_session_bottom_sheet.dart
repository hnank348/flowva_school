                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    sessionId == null
                                        ? 'إضافة الحصة $periodNumber - الفصل الدراسي $semesterId'
                                        : 'تعديل الحصة $periodNumber - الفصل الدراسي $semesterId',
                            ...
                            // 📚 Dropdown المواد الدراسية الآمن
                            BlocBuilder<SubjectsCubit, SubjectsState>(
                              builder: (context, state) {
                                ...
                                if (state is SubjectsSuccess) {
                                  ...
                                  // 🛡️ فحص الأمان: تأكد أن الـ ID متاح بالكامل في اللستة لكي لا ينهار الدوب داون
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      if (selectedSubjectId == null || selectedTeacherId == null) {
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          const SnackBar(
                                            content: Text(
                                              'الرجاء اختيار المادة الدراسية والمعلم أولاً',
                                    ...
                                    child: Text(
                                      sessionId == null ? 'إضافة للجدول' : 'حفظ التعديلات',
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 15,
                                        fontWeight: FontWeight.bold,
