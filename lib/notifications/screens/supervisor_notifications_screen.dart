...
/// ✅ شاشة إشعارات المشرف — بيانات حقيقية من الـ API.
/// حُذفت كل البيانات الوهمية (_seedData) و BlocProvider المحلي؛
/// الـ NotificationsCubit يأتي من AppProviders ويحمل توكن اليوزر.
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    if (state.filteredNotifications.isEmpty)
                      ...
                      // ✅ بدل ListView داخل ListView (كان يسبب مشاكل أداء/تمرير)
